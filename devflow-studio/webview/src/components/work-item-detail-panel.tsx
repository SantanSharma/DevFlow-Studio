...
/**
 * Work item detail content (title, ADO link, journal, description, state,
 * comments) without any drawer shell. Embed inside DetailDrawer or the
 * universal WorkItemsDrawer.
 */
export const WorkItemDetailPanel: React.FC<Props> = ({ id }) => {
...
/**
 * Defense-in-depth sanitizer for ADO description HTML. The webview CSP
 * (default-src 'none', nonce-only scripts) already blocks script execution;
 * this additionally strips active elements, inline event handlers, and
 * javascript: URLs so hostile markup renders inert.
 */
